...
const AdmonitionConfigs = {
  ...
  caution: {
    ...
    label: (
      <Translate id="theme.admonition.caution" description="The default label used for the Caution admonition (:::caution)">
        caution
      </Translate>
    ),
  },
...
function extractMDXAdmonitionTitle(children) {
  ...
  const mdxAdmonitionTitle = items.find((item) => React.isValidElement(item) && item.props?.mdxType === "mdxAdmonitionTitle");
...
export default function Admonition(props) {
  ...
  return (
    <div className={clsx(ThemeClassNames.common.admonition, ThemeClassNames.common.admonitionType(props.type), "alert", `alert--${typeConfig.infimaClassName}`, styles.admonition)}>
