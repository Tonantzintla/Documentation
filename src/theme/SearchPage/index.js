  ...
  return (
    <div className={clsx("col", "col--3", "padding-left--none", styles.searchVersionColumn)}>
      {versionedPluginEntries.map(([pluginId, docsData]) => {
        ...
        return (
          <select key={pluginId} onChange={(e) => docsSearchVersionsHelpers.setSearchVersion(pluginId, e.target.value)} defaultValue={docsSearchVersionsHelpers.searchVersions[pluginId]} className={styles.searchVersionInput}>
  ...
  return (
    <Layout>
      ...
      <div className="margin-vert--lg container">
        ...
        <div className="row">
          <div className={clsx("col", "col--8", styles.searchResultsColumn)}>{!!searchResultState.totalResults && documentsFoundPlural(searchResultState.totalResults)}</div>

          <div className={clsx("col", "col--4", "text--right hidden", styles.searchLogoColumn)}>
            <a
              target="_blank"
