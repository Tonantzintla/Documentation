...
<Tabs>
  <TabItem value="step1" label="Step 1" default>
    ...
    <img src={useBaseUrl("/img/staff/logscommand.png")} alt="Logs Command" />
  </TabItem>
...
If unsure what an error means or you can't deal with it, contact an administrator or higher.
